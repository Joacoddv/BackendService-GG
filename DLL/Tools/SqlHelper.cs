...
namespace DAL.Tools
{
    internal static class SqlHelper
    {
        ...
        static SqlHelper()
        {
            ...
            //conString = "Data Source = JOAQUINDIAZ\\SQLEXPRESS; Initial Catalog = GastroGestion; Integrated Security = True";
            conString = configuration.GetConnectionString("GastroGestion");
        }
